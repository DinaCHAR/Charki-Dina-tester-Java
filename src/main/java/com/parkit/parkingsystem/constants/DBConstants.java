...
public class DBConstants {
    ...
    public static final String COUNT_TICKET = "select count(*) from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? order by t.IN_TIME  limit 1";
}
